...
public class DoctorList extends JFrame {
	...
	public DoctorList() {
		...
		table = new JTable();
		table.setBounds(10, 70, 448, 385);
		contentPane.add(table);
		
		JLabel lblDoctorName = new JLabel("Doctor Name");
		lblDoctorName.setBounds(10, 45, 62, 14);
		contentPane.add(lblDoctorName);
		
		JLabel lblLocation = new JLabel("Location");
		lblLocation.setBounds(136, 45, 46, 14);
		contentPane.add(lblLocation);
		
		JLabel lblCategory = new JLabel("Category");
		lblCategory.setBounds(234, 45, 46, 14);
		contentPane.add(lblCategory);
		
		JLabel lblInsurance = new JLabel("Insurance");
		lblInsurance.setBounds(346, 45, 62, 14);
